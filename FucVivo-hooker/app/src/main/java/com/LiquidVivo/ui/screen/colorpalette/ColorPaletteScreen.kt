package com.LiquidVivo.ui.screen.colorpalette
...
import com.LiquidVivo.LiquidVivoApplication
...
fun ColorPaletteScreen() {
    ...
    val actions = ColorPaletteScreenActions(
        ...
        onSetEnablePredictiveBack = {
            ...
            LiquidVivoApplication.setEnableOnBackInvokedCallback(context.applicationInfo, it)
            activity?.recreate()
        },
