...
import com.LiquidVivo.ui.component.Gate
import com.LiquidVivo.ui.component.dialog.rememberLoadingDialog
import com.LiquidVivo.ui.component.miuix.SendLogDialog
...
fun SettingPagerMiuix(
    ...
    var debugLog by rememberSaveable {
        mutableStateOf(
            XposedState.remotePreferences(HookEntry.PREFS_NAME)
                ...
                item {
                    ...
                    Card(
                        ...
                        SwitchPreference(
                            ...
                            summary = stringResource(R.string.settings_debug_log_summary),
                            checked = debugLog,
                            onCheckedChange = {
                                debugLog = it
                                XposedState.pushLoggingMode(if (it) "debug" else "normal")
                            },
                            startAction = {
                                Icon(
                                    Icons.Rounded.Adb,
