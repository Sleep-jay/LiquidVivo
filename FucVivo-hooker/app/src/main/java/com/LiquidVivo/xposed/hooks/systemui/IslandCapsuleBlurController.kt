...
object IslandCapsuleBlurController {
    ...
    private const val TAG = "LiquidVivoIslandBlur"
    ...
    fun install(module: HookEntry, cl: ClassLoader) {
        ...
        val listener = SharedPreferences.OnSharedPreferenceChangeListener { p, key ->
            when (key) {
                ...
                BlurStyleController.KEY_ENABLE,
                BlurStyleController.KEY_LIQUID_GLASS,
                BlurStyleController.KEY_GLASS_OPACITY -> reapplyMaterialIfActive()
            }
        }
        listeners += listener
