package com.FucVivo.ui.component.bottombar
...
import com.FucVivo.ui.LocalMainPagerState
import com.FucVivo.ui.component.FloatingBottomBar
import com.FucVivo.ui.component.FloatingBottomBarItem
import com.FucVivo.ui.theme.LocalEnableFloatingBottomBar
import com.FucVivo.ui.theme.LocalEnableFloatingBottomBarBlur
import com.FucVivo.ui.util.BlurredBar
...
fun BottomBarMiuix(
    ...
    // 模板仅保留三个标签页：模块 / 应用 / 设置（仅保留三标签）
    val items = BottomBarDestination.entries
        .filter { it != BottomBarDestination.Module }
        .map { destination ->
        NavigationItem(
...
enum class BottomBarDestination(
    ...
    Home(R.string.tab_module, Icons.Rounded.Cottage),
    SuperUser(R.string.tab_apps, Icons.Rounded.Person),
