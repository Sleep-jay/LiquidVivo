...
import com.LiquidVivo.data.repository.SettingsRepositoryImpl
...
lateinit var fvApp: LiquidVivoApplication

class LiquidVivoApplication : Application(), ViewModelStoreOwner {
    ...
    override fun onCreate() {
        ...
        com.LiquidVivo.xposed.XposedState.init()
                ...
                .addInterceptor { block ->
                    block.proceed(
                        block.request().newBuilder()
                            .header("User-Agent", "LiquidVivo/${BuildConfig.VERSION_CODE}")
